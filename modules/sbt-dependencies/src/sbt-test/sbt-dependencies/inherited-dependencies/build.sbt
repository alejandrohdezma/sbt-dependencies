...
assertTest := {
  ...
  val expectedCoreDeps = List("cats-core", "scala-library").sorted
  ...
  val expectedAppInherited = List("cats-core", "scala-library").sorted
  ...
  val expectedAppDeps = List("cats-effect", "scala-library").sorted
