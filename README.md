...
```sbt
addSbtPlugin("com.alejandrohdezma" % "sbt-dependencies" % "0.33.0")
```
...
- **[IntelliJ IDEA plugin](ide-plugins/intellij/README.md)**: syntax highlighting, diagnostics with quick fixes, hovers, resolved versions and BOM provenance, structure view, formatting that mirrors the `dependenciesFormat` task, paste conversion, `build.sbt` navigation and sbt tasks.
