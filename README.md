...
```sbt
addSbtPlugin("com.alejandrohdezma" % "sbt-dependencies" % "0.39.0")
```
...
Reference it as `alejandrohdezma/sbt-dependencies@v0.39.0`:
...
jobs:
  update:
    ...
    steps:
      ...
      - uses: alejandrohdezma/sbt-dependencies@v0.39.0
        with:
