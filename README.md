...
```sbt
addSbtPlugin("com.alejandrohdezma" % "sbt-dependencies" % "0.38.0")
```
...
Reference it as `alejandrohdezma/sbt-dependencies@v0.38.0`:
...
jobs:
  update:
    ...
    steps:
      ...
      - uses: alejandrohdezma/sbt-dependencies@v0.38.0
        with:
